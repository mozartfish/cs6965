...
projected_data = mapper.fit_transform(data, projection=sklearn.manifold.SpectralEmbedding(n_components= 3, random_state=0, eigen_solver='arpack'))
...
mapper.visualize(
    ...
    path_html="output/digits_custom_tooltips1.html",
    color_values=labels,
...
mapper.visualize(
    graph,
    title="Handwritten digits Mapper",
    path_html="output/digits_ylabel_tooltips1.html",
